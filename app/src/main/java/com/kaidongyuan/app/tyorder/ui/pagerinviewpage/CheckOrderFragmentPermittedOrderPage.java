...
import com.kaidongyuan.app.tyorder.model.CheckOrderFragmentPermittedOrderPagerBiz;
 ...
 * 已完成订单界面
 */
public class CheckOrderFragmentPermittedOrderPage implements PagerNecessaryInterface, AdapterView.OnItemClickListener, View.OnClickListener {
     ...
     * 已完成订单界面业务类
     */
    private CheckOrderFragmentPermittedOrderPagerBiz mBiz;
    ...
    public CheckOrderFragmentPermittedOrderPage(Context context) {
        try {
    ...
    private void init() {
        try {
            mBiz = new CheckOrderFragmentPermittedOrderPagerBiz(this);
        } catch (Exception e) {
            ExceptionUtil.handlerException(e);
        }
    }
    ...
    private void initView() {
        try {
            ...
            this.mOrderListApapter = new OrderListAdapter(mContext, null,false);
