...
public class PromotionDetail implements Parcelable {
	...
	/** 此赠品信息对应的库存 */
	public float LOTTABLE11;
	/** 此赠品信息调价上限数 通宇产品全部价格上限9999999 */
	public double LOTTABLE12=9999999d;
	/** 此赠品信息调价下限数 通宇项目全部价格下限0 */
	public double LOTTABLE13=0d;
	/**
	 * 20171018 通宇产品库存数量
	 */
