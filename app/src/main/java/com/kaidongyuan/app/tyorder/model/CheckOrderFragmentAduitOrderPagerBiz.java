 ...
 * 已完成订单业务类
 */
public class CheckOrderFragmentAduitOrderPagerBiz {

    private CheckOrderFragmentAduitOrderPage mPager;
    ...
    public CheckOrderFragmentAduitOrderPagerBiz(CheckOrderFragmentAduitOrderPage pager) {
        try {
            this.mPager = pager;
        ...
        try {
            StringRequest request = new StringRequest(Request.Method.POST, URLCostant.GET_ORDER_LIST, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    Logger.w(CheckOrderFragmentAduitOrderPagerBiz.this.getClass() + ".getOrderDataSuccess:" + response);
                    getOrderDataSuccess(response);
                }
            }, new Response.ErrorListener() {
                @Override
                public void onErrorResponse(VolleyError error) {
                    Logger.w(CheckOrderFragmentAduitOrderPagerBiz.this.getClass() + ".getOrderDataError:" + error.toString());
