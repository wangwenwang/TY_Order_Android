...
public class Product implements Parcelable {
    ...
    public float getCHOICED_SIZE() {
        return CHOICED_SIZE;
    }

    public void setCHOICED_SIZE(float CHOICED_SIZE) {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeFloat(CHOICED_SIZE);
        dest.writeDouble(PRODUCT_CURRENT_PRICE);
        dest.writeFloat(QTYAVAILABLE);
    ...
    public Product(Parcel in) {
        ...
        CHOICED_SIZE=in.readFloat();
        PRODUCT_CURRENT_PRICE=in.readDouble();
        QTYAVAILABLE=in.readFloat();
