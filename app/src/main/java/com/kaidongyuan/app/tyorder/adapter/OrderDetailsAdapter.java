...
public class OrderDetailsAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.tv_productDesc= (TextView) convertView.findViewById(R.id.tv_productDesc);
        ...
        String productDesc=CheckStringEmptyUtil.checkStringIsEmptyWithNoSet(orderDetail.getPRODUCT_DESC());
        holder.tv_productDesc.setText(productDesc);
        ...
        int pointIndex = totalPrice.indexOf(".");
        if (pointIndex != -1&&totalPrice.length()>pointIndex+4) {
            totalPrice = totalPrice.substring(0, pointIndex + 4);
        }
    ...
    class Holder {
        TextView tv_productName,tv_productDesc, tv_order_qty, tv_order_weight, tv_order_volume,
