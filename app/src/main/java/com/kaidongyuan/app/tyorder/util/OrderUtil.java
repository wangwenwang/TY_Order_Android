package com.kaidongyuan.app.tyorder.util;
...
public class OrderUtil {
     ...
     * @return
     */
    public static PromotionDetail getPromotionDetailByProduct(Product product, String PRODUCT_TYPE, int LINE_NO, float PO_QTY, long OPERATOR_IDX, double ACT_PRICE){
        ...
        p.LINE_NO = LINE_NO;
        p.PO_QTY = PO_QTY;
        p.PO_UOM=product.getPRODUCT_UOM();
