...
import com.kaidongyuan.app.tyorder.model.CheckOrderFragmentAduitOrderPagerBiz;
 ...
 * 已审核订单界面
 */
public class CheckOrderFragmentAduitOrderPage implements PagerNecessaryInterface, AdapterView.OnItemClickListener, View.OnClickListener {
     ...
     * 已完成订单界面业务类
     */
    private CheckOrderFragmentAduitOrderPagerBiz mBiz;
    ...
    public CheckOrderFragmentAduitOrderPage(Context context) {
        try {
    ...
    private void init() {
        try {
            mBiz = new CheckOrderFragmentAduitOrderPagerBiz(this);
        } catch (Exception e) {
            ExceptionUtil.handlerException(e);
        }
    }
