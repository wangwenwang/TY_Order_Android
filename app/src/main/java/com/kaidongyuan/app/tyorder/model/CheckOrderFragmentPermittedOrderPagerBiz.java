 ...
 * 已完成订单业务类
 */
public class CheckOrderFragmentPermittedOrderPagerBiz {

    private CheckOrderFragmentPermittedOrderPage mPager;
    ...
    public CheckOrderFragmentPermittedOrderPagerBiz(CheckOrderFragmentPermittedOrderPage pager) {
        try {
            this.mPager = pager;
        ...
        try {
            StringRequest request = new StringRequest(Request.Method.POST, URLCostant.GET_ORDER_LIST, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    Logger.w(CheckOrderFragmentPermittedOrderPagerBiz.this.getClass() + ".getOrderDataSuccess:" + response);
                    getOrderDataSuccess(response);
                }
            }, new Response.ErrorListener() {
                @Override
                public void onErrorResponse(VolleyError error) {
                    Logger.w(CheckOrderFragmentPermittedOrderPagerBiz.this.getClass() + ".getOrderDataError:" + error.toString());
