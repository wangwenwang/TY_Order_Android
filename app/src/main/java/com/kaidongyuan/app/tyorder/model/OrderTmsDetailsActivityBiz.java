...
import com.kaidongyuan.app.tyorder.ui.activity.OrderTmsDetailsActivity;
...
public class OrderTmsDetailsActivityBiz {
    ...
    private String REFERENCE01,REFERENCE04;
    ...
    public OrderTmsDetailsActivity getmActivity() {
        return mActivity;
    }
    ...
    private void getOrderDetailsDataSuccess(String response) {
        try {
            ...
            ExceptionUtil.handlerException(e);
            mActivity.getOrderDetailsDataError("未获取到订单物流装运详情！");
        }
    }
