...
public class HotSellProductAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		String productName = CheckStringEmptyUtil.checkStringIsEmptyWithNoSet(product.getPRODUCT_NAME().trim());
		holder.tv_productName.setText(productName);

		String productStyle = CheckStringEmptyUtil.checkStringIsEmptyWithNoSet(product.getPRODUCT_DESC().trim());
