...
import com.kaidongyuan.app.tyorder.adapter.OrderTmsAdapter;
import com.kaidongyuan.app.tyorder.app.MyApplication;
import com.kaidongyuan.app.tyorder.bean.Order;
import com.kaidongyuan.app.tyorder.bean.OrderTms;
import com.kaidongyuan.app.tyorder.constants.EXTRAConstants;
import com.kaidongyuan.app.tyorder.model.OrderTransInformationActivityBiz;
    ...
    private void getData() {
        try {
            ...
            if (intent.hasExtra(EXTRAConstants.ORDER_DETAILSACTIVITY_ORDER_ID)) {
                Long orderId = intent.getLongExtra(EXTRAConstants.ORDER_DETAILSACTIVITY_ORDER_ID,-1);
