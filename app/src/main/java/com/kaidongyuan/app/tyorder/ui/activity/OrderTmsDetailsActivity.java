...
import com.kaidongyuan.app.tyorder.adapter.OrderDetailsSimpleAdapter;
...
import com.kaidongyuan.app.tyorder.model.OrderTmsDetailsActivityBiz;
...
public class OrderTmsDetailsActivity extends BaseActivity implements View.OnClickListener {
     ...
     * 中转单号
     */
    private TextView mTextViewOrderREFERENCE01;
    /**
     * 中转电话
     */
    private TextView mTextViewOrderREFERENCE04;
    /**
     * 货物信息
     */
    ...
    protected void onDestroy() {
        try {
            ...
            this.mTextViewOrderREFERENCE01=null;
            this.mTextViewOrderREFERENCE04=null;
    ...
    private void initView() {
        try {
            ...
            this.mTextViewOrderREFERENCE01= (TextView) this.findViewById(R.id.tv_order_REFERENCE01);
            this.mTextViewOrderREFERENCE04= (TextView) this.findViewById(R.id.tv_order_REFERENCE04);
    ...
    public void getOrderDetailsDtaSuccess() {
        try {
            ...
            if (order != null) {
                ...
                String orderReference01 = CheckStringEmptyUtil.checkStringIsEmptyWithNoSet(order.getShipment().getREFERENCE01());
                mTextViewOrderREFERENCE01.setText(orderReference01);
                String orderReference04= CheckStringEmptyUtil.checkStringIsEmptyWithNoSet(order.getShipment().getREFERENCE04());
                mTextViewOrderREFERENCE04.setText(orderReference04);
