...
import com.kaidongyuan.app.tyorder.widget.ScanfProductPriceDialog;
...
public class OrderProductDetailAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.ll_stock_qty= (LinearLayout) convertView.findViewById(R.id.ll_productInventory);
            holder.tv_stock_qty= (TextView) convertView.findViewById(R.id.tv_productInventory);
            holder.ll_stock_qty.setVisibility(View.VISIBLE);
        ...
        holder.tv_stock_qty.setText(promotionDetail.stock_qty+"");
        if (BusinessConstants.CAN_MODIFY_PRICE.equals(promotionDetail.LOTTABLE06)) {
